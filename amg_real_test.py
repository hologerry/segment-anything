...
def main(args) -> None:
    ...
    anno_json = f"{args.sub_dir}_anno.json"
    ...
    for item in tqdm(data_dict):
        image_path = os.path.join(args.root_dir, args.sub_dir, item["image"])
        ...
        for label in labels:
            ...
            out_mask_path = image_path.replace("Color", f"Mask_{label_class}").replace("_resize", "")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir", type=str, default="../data/RealTest")
    parser.add_argument("--sub_dir", type=str, default="0827_test")
